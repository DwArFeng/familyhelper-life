 ...
 * @since 1.1.0
 */
public class JSFixedFastJsonActivity implements Bean {

    private static final long serialVersionUID = -611341810563693950L;

    public static JSFixedFastJsonActivity of(Activity activity) {
        if (Objects.isNull(activity)) {
            return null;
        } else {
            return new JSFixedFastJsonActivity(
                    JSFixedFastJsonLongIdKey.of(activity.getKey()),
    ...
    public JSFixedFastJsonActivity() {
    }
    ...
    public String toString() {
        return "JSFixedFastJsonActivity{" +
                "key=" + key +
