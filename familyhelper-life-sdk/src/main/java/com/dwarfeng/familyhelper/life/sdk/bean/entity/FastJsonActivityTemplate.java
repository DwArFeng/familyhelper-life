 ...
 * @since 1.1.0
 */
public class FastJsonActivityTemplate implements Bean {

    private static final long serialVersionUID = 9217338890846752690L;

    public static FastJsonActivityTemplate of(ActivityTemplate activityTemplate) {
        if (Objects.isNull(activityTemplate)) {
            return null;
        } else {
            return new FastJsonActivityTemplate(
                    FastJsonLongIdKey.of(activityTemplate.getKey()),
    ...
    public FastJsonActivityTemplate() {
    }

    public FastJsonActivityTemplate(
            FastJsonLongIdKey key, String activityType, String name, String remark, String activityNameTemplate,
    ...
    public String toString() {
        return "FastJsonActivityTemplate{" +
                "key=" + key +
