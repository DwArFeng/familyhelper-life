...
/**
 * JSFixedFastJson 活动模板权限主键。
 *
 * @author DwArFeng
 * @since 1.1.0
 */
public class JSFixedFastJsonPoatKey implements Key {

    private static final long serialVersionUID = 3563819337845664868L;

    public static JSFixedFastJsonPoatKey of(PoatKey poatKey) {
        if (Objects.isNull(poatKey)) {
            return null;
        } else {
            return new JSFixedFastJsonPoatKey(
    ...
    public JSFixedFastJsonPoatKey() {
    }

    public JSFixedFastJsonPoatKey(Long activityTemplateLongId, String userStringId) {
    ...
    public boolean equals(Object o) {
        ...
        JSFixedFastJsonPoatKey that = (JSFixedFastJsonPoatKey) o;
