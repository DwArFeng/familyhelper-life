 ...
 * @since 1.0.0
 */
public class PbNode implements Entity<LongIdKey> {

    private static final long serialVersionUID = -3857725566288863996L;
    ...
    public PbNode(LongIdKey key, LongIdKey parentKey, LongIdKey setKey, String name, String remark) {
        this.key = key;
