 ...
 * @since 1.1.0
 */
public interface ActivityDataSetOperateHandler extends Handler {
     ...
     * @throws HandlerException 处理器异常。
     */
    void removeActivityDataSet(StringIdKey userKey, LongIdKey activityDataSetKey) throws HandlerException;
