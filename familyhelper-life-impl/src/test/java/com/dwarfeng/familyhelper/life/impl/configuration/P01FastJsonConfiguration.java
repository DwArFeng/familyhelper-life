...
@Configuration
public class P01FastJsonConfiguration {

    private static final Logger LOGGER = LoggerFactory.getLogger(P01FastJsonConfiguration.class);

    public P01FastJsonConfiguration() {
