...
import com.dwarfeng.familyhelper.life.sdk.bean.entity.FastJsonActivityCoverInfo;
import com.dwarfeng.familyhelper.life.stack.bean.entity.ActivityCoverInfo;
import com.dwarfeng.familyhelper.life.stack.cache.ActivityCoverInfoCache;
...
@Repository
public class ActivityCoverInfoCacheImpl implements ActivityCoverInfoCache {

    private final RedisBatchBaseCache<LongIdKey, ActivityCoverInfo, FastJsonActivityCoverInfo> batchBaseCache;

    public ActivityCoverInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, ActivityCoverInfo, FastJsonActivityCoverInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityCoverInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(ActivityCoverInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityCoverInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityCoverInfo> entities, long timeout) throws CacheException {
