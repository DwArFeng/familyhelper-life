...
@Component
public class ActivityParticipantPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case ActivityParticipantMaintainService.CHILD_FOR_ACTIVITY:
                childForActivity(detachedCriteria, objects);
                break;
            case ActivityParticipantMaintainService.CHILD_FOR_USER:
