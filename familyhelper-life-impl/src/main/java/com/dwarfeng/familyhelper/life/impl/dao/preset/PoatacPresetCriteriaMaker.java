...
@Component
public class PoatacPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case PoatacMaintainService.CHILD_FOR_ACTIVITY_TEMPLATE:
                childForActivityTemplate(detachedCriteria, objects);
                break;
            case PoatacMaintainService.CHILD_FOR_USER:
                childForUser(detachedCriteria, objects);
                break;
            case PoatacMaintainService.CHILD_FOR_ACTIVITY_TEMPLATE_PERMISSION_LEVEL_EQUALS:
                childForActivityTemplatePermissionLevelEquals(detachedCriteria, objects);
                break;
            case PoatacMaintainService.CHILD_FOR_USER_PERMISSION_LEVEL_EQUALS:
