...
public class DubboResetter extends AbstractResetter {
    ...
    public interface DubboResetService extends Service {
         ...
         */
        boolean resetActivityTemplateDrive() throws ServiceException;
    }
    ...
    public class DubboResetServiceImpl implements DubboResetService {
        ...
        @Override
        public boolean resetActivityTemplateDrive() throws ServiceException {
            try {
                LOGGER.info("接收到活动模板驱动功能重置消息, 正在重置活动模板驱动功能...");
