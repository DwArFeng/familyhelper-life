...
import com.dwarfeng.familyhelper.life.sdk.bean.entity.FastJsonActivityDataSet;
...
@Repository
public class ActivityDataSetCacheImpl implements ActivityDataSetCache {

    private final RedisBatchBaseCache<LongIdKey, ActivityDataSet, FastJsonActivityDataSet> batchBaseCache;

    public ActivityDataSetCacheImpl(
            RedisBatchBaseCache<LongIdKey, ActivityDataSet, FastJsonActivityDataSet> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityDataSet get(LongIdKey key) throws CacheException {
    ...
    public void push(ActivityDataSet value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityDataSet> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityDataSet> entities, long timeout) throws CacheException {
