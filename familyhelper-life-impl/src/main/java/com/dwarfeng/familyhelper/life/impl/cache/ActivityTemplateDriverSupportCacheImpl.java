...
import com.dwarfeng.familyhelper.life.stack.cache.ActivityTemplateDriverSupportCache;
...
@Repository
public class ActivityTemplateDriverSupportCacheImpl implements ActivityTemplateDriverSupportCache {

    private final RedisBatchBaseCache<StringIdKey, ActivityTemplateDriverSupport,
            FastJsonActivityTemplateDriverSupport> batchBaseCache;

    public ActivityTemplateDriverSupportCacheImpl(
            RedisBatchBaseCache<StringIdKey, ActivityTemplateDriverSupport, FastJsonActivityTemplateDriverSupport>
                    batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityTemplateDriverSupport get(StringIdKey key) throws CacheException {
    ...
    public void push(ActivityTemplateDriverSupport value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityTemplateDriverSupport> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityTemplateDriverSupport> entities, long timeout) throws CacheException {
