...
import com.dwarfeng.familyhelper.life.sdk.bean.entity.FastJsonActivityDataNode;
...
@Repository
public class ActivityDataNodeCacheImpl implements ActivityDataNodeCache {

    private final RedisBatchBaseCache<LongIdKey, ActivityDataNode, FastJsonActivityDataNode> batchBaseCache;

    public ActivityDataNodeCacheImpl(
            RedisBatchBaseCache<LongIdKey, ActivityDataNode, FastJsonActivityDataNode> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityDataNode get(LongIdKey key) throws CacheException {
    ...
    public void push(ActivityDataNode value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityDataNode> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityDataNode> entities, long timeout) throws CacheException {
