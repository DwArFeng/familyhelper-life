...
import com.dwarfeng.familyhelper.life.stack.handler.Resetter;
...
public class ResetCommand extends CliCommand {
    ...
    private static final String COMMAND_OPTION_RESET_ACTIVITY_TEMPLATE_DRIVE = "reset-atdrive";
    ...
    private static final String[] COMMAND_OPTION_ARRAY = new String[]{
            ...
            COMMAND_OPTION_RESET_ACTIVITY_TEMPLATE_DRIVE
    };
    ...
    private static final String CMD_LINE_SYNTAX_RESET_DRIVE = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_ACTIVITY_TEMPLATE_DRIVE);
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_ACTIVITY_TEMPLATE_DRIVE).desc("执行驱动重置操作").build());
        return list;
    }
        ...
        try {
            ...
            switch (pair.getLeft()) {
                ...
                case COMMAND_OPTION_STATUS:
                    printStatus(context);
                    break;
                case COMMAND_OPTION_RESET_ACTIVITY_TEMPLATE_DRIVE:
                    resetQosService.resetActivityTemplateDrive();
