...
import com.dwarfeng.familyhelper.life.stack.cache.ActivityCache;
...
public class ActivityCacheImpl implements ActivityCache {
    ...
    private final RedisBatchBaseCache<LongIdKey, Activity, FastJsonActivity> batchBaseCache;

    public ActivityCacheImpl(
            RedisBatchBaseCache<LongIdKey, Activity, FastJsonActivity> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Activity get(LongIdKey key) throws CacheException {
    ...
    public void push(Activity value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Activity> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<Activity> entities, long timeout) throws CacheException {
