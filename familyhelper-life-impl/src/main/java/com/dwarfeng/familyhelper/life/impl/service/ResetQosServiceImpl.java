...
import com.dwarfeng.familyhelper.life.stack.handler.ResetHandler;
import com.dwarfeng.familyhelper.life.stack.handler.Resetter;
import com.dwarfeng.familyhelper.life.stack.handler.ResetterHandler;
...
public class ResetQosServiceImpl implements ResetQosService {
    ...
    @Override
    public void resetActivityTemplateDrive() throws ServiceException {
        try {
            resetHandler.resetActivityTemplateDrive();
        } catch (Exception e) {
            throw ServiceExceptionHelper.logParse("重置活动模板驱动时发生异常", LogLevel.WARN, e, sem);
        }
    }
}
