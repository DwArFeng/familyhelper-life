...
@Component
public class ActivityTemplateDriverSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case ActivityTemplateDriverSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case ActivityTemplateDriverSupportMaintainService.LABEL_LIKE:
