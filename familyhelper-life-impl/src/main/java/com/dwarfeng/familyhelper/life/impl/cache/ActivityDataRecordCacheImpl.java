...
import com.dwarfeng.familyhelper.life.sdk.bean.entity.FastJsonActivityDataRecord;
...
@Repository
public class ActivityDataRecordCacheImpl implements ActivityDataRecordCache {

    private final RedisBatchBaseCache<LongIdKey, ActivityDataRecord, FastJsonActivityDataRecord> batchBaseCache;

    public ActivityDataRecordCacheImpl(
            RedisBatchBaseCache<LongIdKey, ActivityDataRecord, FastJsonActivityDataRecord> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityDataRecord get(LongIdKey key) throws CacheException {
    ...
    public void push(ActivityDataRecord value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityDataRecord> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityDataRecord> entities, long timeout) throws CacheException {
