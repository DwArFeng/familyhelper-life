...
@Table(name = "tbl_activity_file_info")
public class HibernateActivityFileInfo implements Bean {

    private static final long serialVersionUID = 2916235584423550399L;
    ...
    public HibernateActivityFileInfo() {
    }
