...
import com.dwarfeng.familyhelper.life.impl.bean.key.HibernatePoatacKey;
...
@Entity
@IdClass(HibernatePoatacKey.class)
@Table(name = "tbl_poatac")
public class HibernatePoatac implements Bean {

    private static final long serialVersionUID = -6079433213438576498L;
    ...
    public HibernatePoatac() {
    }

    // -----------------------------------------------------------映射用属性区-----------------------------------------------------------
    public HibernatePoatacKey getKey() {
        return new HibernatePoatacKey(activityTemplateLongId, userStringId);
    }

    public void setKey(HibernatePoatacKey key) {
