...
import com.dwarfeng.familyhelper.life.sdk.bean.entity.FastJsonActivityDataItem;
...
@Repository
public class ActivityDataItemCacheImpl implements ActivityDataItemCache {

    private final RedisBatchBaseCache<LongIdKey, ActivityDataItem, FastJsonActivityDataItem> batchBaseCache;

    public ActivityDataItemCacheImpl(
            RedisBatchBaseCache<LongIdKey, ActivityDataItem, FastJsonActivityDataItem> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityDataItem get(LongIdKey key) throws CacheException {
    ...
    public void push(ActivityDataItem value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityDataItem> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityDataItem> entities, long timeout) throws CacheException {
