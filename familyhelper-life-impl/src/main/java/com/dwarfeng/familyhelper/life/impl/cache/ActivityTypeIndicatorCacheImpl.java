...
import com.dwarfeng.familyhelper.life.stack.cache.ActivityTypeIndicatorCache;
...
@Repository
public class ActivityTypeIndicatorCacheImpl implements ActivityTypeIndicatorCache {

    private final RedisBatchBaseCache<StringIdKey, ActivityTypeIndicator, FastJsonActivityTypeIndicator> batchBaseCache;

    public ActivityTypeIndicatorCacheImpl(
            RedisBatchBaseCache<StringIdKey, ActivityTypeIndicator, FastJsonActivityTypeIndicator> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ActivityTypeIndicator get(StringIdKey key) throws CacheException {
    ...
    public void push(ActivityTypeIndicator value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ActivityTypeIndicator> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ActivityTypeIndicator> entities, long timeout) throws CacheException {
