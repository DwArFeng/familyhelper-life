...
@Component
public class PbNodePresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case PbNodeMaintainService.CHILD_FOR_PARENT:
                childForParent(detachedCriteria, objects);
                break;
            case PbNodeMaintainService.CHILD_FOR_SET:
                childForSet(detachedCriteria, objects);
                break;
            case PbNodeMaintainService.CHILD_FOR_SET_ROOT:
                childForSetRoot(detachedCriteria, objects);
                break;
            case PbNodeMaintainService.NAME_LIKE:
                nameLike(detachedCriteria, objects);
                break;
            case PbNodeMaintainService.CHILD_FOR_SET_NAME_LIKE:
